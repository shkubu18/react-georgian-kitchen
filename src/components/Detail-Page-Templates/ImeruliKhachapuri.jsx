...
export default function DetailImeruliKhachapuri() {
    return (
        <div className="food-info-container">
            <div className="food-info">
                <div className="food-img-container">
                    <img src="https://img.freepik.com/premium-photo/fresh-baked-khachapuri-imeruli-imeretian-cheesefilled-georgian-flatbread-wooden-plate_76000-4885.jpg?w=2000" alt="food-img" />
                </div>
                <div className="food-detail-info">
                    <div>
                        <h1>Imeruli Khachapuri</h1>
                    </div>
                    ...
                    <div>
                        <p>Who invented Imeruli Khachapuri</p>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam, expedita, ipsum dolor minima non
                            beatae perferendis optio maiores aliquid, possimus saepe natus labore earum voluptates incidunt
                            quam tempore porro hic.</p>
                    </div>
                    <div className="for-more-info imeruli-khachapuri">
